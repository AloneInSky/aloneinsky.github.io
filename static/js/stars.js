...
const main = () => {
    ...
    geometrys[0].setAttribute(
        "position",
        new THREE.BufferAttribute(getRandomParticelPos(512), 3)
    );
    geometrys[1].setAttribute(
        "position",
        new THREE.BufferAttribute(getRandomParticelPos(1536), 3)
    );
    ...
    const render = (time) => {
        ...
        starsT1.position.x = mouseX * 0.0002;
        starsT1.position.y = mouseY * -0.0002;

        starsT2.position.x = mouseX * 0.0002;
        starsT2.position.y = mouseY * -0.0002;
